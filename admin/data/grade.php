 ...
 * @return array Az osztályzatok tömbje (üres tömb, ha nincs adat)
 */
function getAllGrades(PDO $pdo): array {
    ...
    // Minden osztályzat lekérése asszociatív tömbként
...
function getGradeById(int $grade_id, PDO $pdo): ?array {
    ...
    // Egyetlen osztályzat visszaadása asszociatív tömbként, vagy null ha nincs
