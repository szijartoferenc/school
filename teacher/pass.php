...
<head>
    ...
    <title>Tanár - Jelszó változtatás</title>
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column">
        <form method="post" class="shadow p-3 my-5 form-w" action="request/changeTeacher.php" id="change_password">
            <h3>Jelszó változtatás</h3><hr>
            ...
            <!-- Új jelszó és véletlenszerű generálás -->
            <div class="mb-3">
    ...
    <script>
        ...
        gBtn.addEventListener('click', function(e){
            ...
            makePass(8); // 8 karakter hosszú jelszót generál
        });
    </script>
</body>
</html>
